...
namespace SEDC.VideoRental.Services.Menus
{
    public class Screen
    {
        ...
        public static void AdminMenuShowUsers()
        {
           
            Console.WriteLine("Use the numbers in front of the selection to navigate thru the applicaton.");
            Console.WriteLine("1. View all users");
            Console.WriteLine("2. Register new users");
            Console.WriteLine("3. Delete a users");
            Console.WriteLine("0. Go Back");
        }

        public static void AdminMenuShowVideos()
        {

            Console.WriteLine("Use the numbers in front of the selection to navigate thru the applicaton.");
            Console.WriteLine("1. View all videos");
            Console.WriteLine("2. Add new video");
            Console.WriteLine("3. Delete a video");
            Console.WriteLine("0. Go Back");
        }
    }
}
