    ...
    public class InMemoryDatabase
    {
        ...
        private void InitDatabase()
        {
            Users = new List<User>
            {
                ...
                new User() { CardNumber = 112, FullName = "Admin", IsAdmin = true }
            };
            //new Movie("Iron Man", 14, Genre.Action, 1, "EN", true, 180, 4, new DateTime(2008, 5, 2)),
            //    new Movie("The Incredible Hulk", 16, Genre.Action, 2, "EN", true, 220, 7, new DateTime(2008, 6, 13)),
