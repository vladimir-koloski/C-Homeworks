...
namespace SEDC.Class06.Exercises.Bussiness.Services
{
    public static class Authentication
    {
        ...
        {
            string email = EnterEmail(validationService, users);
        ...
        public static User Login(User[] users, ValidationService validationSevice)
        {
            while (true)
            {
        ...
        private static string EnterEmail(ValidationService validationSevice, User[] users)
        {
            while (true)
            {
        ...
        private static string EnterPassword(ValidationService validationSevice)
        {
            while (true)
            {
